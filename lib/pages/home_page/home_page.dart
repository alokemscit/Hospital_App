...
import 'package:asgar_ali_hospital/pages/pat_reg/pages/pat_reg_page.dart';
...
_setDocTapID(HomePageController c, String x) {
  c.tapDocID.value = x;
  print(x);
}
...
_imageDoctor(HomePageController controller) => Container(
      ...
      child: ListView.builder(
        ...
        itemCount: controller.list_doctor_top.length,
        itemBuilder: (context, index) {
          return Padding(
            padding: const EdgeInsets.symmetric(horizontal: 4, vertical: 4),
            child: InkWell(
                onTapDown: (_) => _setDocTapID(
                    controller, controller.list_doctor_top[index].docId!),
                onTapUp: (_) => _setDocTapID(controller, ''),
                onTapCancel: () => _setDocTapID(controller, ''),
                ...
                onTap: () {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return DoctorAppointment(
                      doctorMaster: controller.list_doctor_top[index],
                    );
                  }));
                },
                child: Obx(
                  () => AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: controller.tapDocID.value ==
                                controller.list_doctor_top[index].docId!
                            ? appColorPista
                            : Colors.white,
                        boxShadow: [
                          BoxShadow(
                      ...
                      children: [
                        SizedBox(
                            ...
                            child: Obx(() => controller.isLoading.value
                                ? const SizedBox()
                                : Image.network(
                                    'https://web.asgaralihospital.com/pub/doc_image/${controller.list_doctor_top[index].imagePath!}',
                                  ))),
                        Positioned(
                            left: 0,
                            right: 0,
                                        ...
                                        child: Column(
                                          children: [
                                            Text(
                                              ...
                                              controller.list_doctor_top[index]
                                                      .docName!.isEmpty
                                                  ? ""
                                                  : controller
                                                      .list_doctor_top[index]
                                                      .docName!,
...
_gridView(HomePageController controller) {
  void _setTapIndex(String x) {
    controller.tapIndex.value = x;
    print(x);
  }
  ...
  return Padding(
    ...
    child: GridView.builder(
      ...
      itemBuilder: (BuildContext context, index) {
        ...
        return InkWell(
            onTapDown: (_) => _setTapIndex(list.id),
            onTapUp: (_) => _setTapIndex(''),
            onTapCancel: () => _setTapIndex(''),
            splashColor: appColorBlue,
            focusColor: appColorBlue,
            ...
            onTap: () {
              ...
              if (iconList[index].id == '2') {
                Get.to(const PatientReg());
              }
            },
            child: Obx(
              () => AnimatedContainer(
                ...
                decoration: BoxDecoration(
                    ...
                    color: list.id == controller.tapIndex.value
                        ? appColorPista
                        : Colors.white,
                    boxShadow: const [
                      BoxShadow(
                          ...
                          decoration: const BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                ...
                                blurRadius: 20,
                                offset: Offset(
                                    0, 0), // x, y changes position of shadow
                              )
                            ],
                          ),
                          child: Center(
                            child: Opacity(
                              ...
                              child: Image.asset(
                                ...
                                height: 30,
                                width: 30,
                                color: controller.tapIndex.value == list.id
                                    ? appColorLogoDeep
                                    : appColorGrayDark,
                                fit: BoxFit.cover,
                              ),
...
_cursol_part(HomePageController controller) => Row(
      children: [
        Expanded(
          child: Container(
            height: 90,
            ...
            child: CarouselSlider.builder(
              itemCount: controller.lis_banner.length,
              ...
              itemBuilder: (context, index, realIdx) {
                //  print(controller.lis_banner[index]);
                return Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Opacity(
                      opacity: 0.8,
                      child: Image.network(
                        'https://web.asgaralihospital.com/pub/app_banner/${controller.lis_banner[index].name}',
