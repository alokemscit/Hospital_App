  ...
  Widget build(BuildContext context) {
   // DoctorPageController dcontroller = Get.find<DoctorPageController>();
    DoctorAppointmentController controller = Get.put(
        DoctorAppointmentController(docId: doctorMaster.docId!));
                                        ...
                                        TableCell(
                                            ...
                                            child: InkWell(
                                              ...
                                              child: const Padding(
                                                ...
                                                child:  Icon(Icons.arrow_forward_ios,size: 18,color: appColorGrayDark,),
                                              ),
                                            ))
                                      ]))
                                  .toList()),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    _degree(
                        dcontroller.deptName, Colors.black87, 13),
                    _degree(
                        dcontroller.desig, appColorGrayDark, 12),
